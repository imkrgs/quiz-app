          ...
          if (type === "object") {
            if (red instanceof color) {
              ...
              each(spaces, function (spaceName, space) {
                ...
                if (
                  inst[cache] &&
                  $.inArray(null, inst[cache].slice(0, 3)) < 0
                ) {
    ...
    _create: function () {
      ...
      this._on(this.menu.element, {
        ...
        menufocus: function (event, ui) {
          ...
          var item =
            ui.item.data("ui-autocomplete-item") ||
...
(function ($, undefined) {
  ...
  $.widget("ui.dialog", {
    ...
    _create: function () {
      ...
      uiDialogButtonPane = (this.uiDialogButtonPane = $("<div>")).addClass(
  ...
  $.extend($.ui.dialog.overlay, {
    ...
    create: function (dialog) {
      ...
      var $el =
        this.oldInstances.pop() || $("<div>").addClass("ui-widget-overlay");
  ...
  $.effects.effect.highlight = function (o, done) {
    ...
    elem
      ...
      .css({
        ...
        backgroundColor: o.color || "#5ff2be",
      })
      .animate(animation, {
        queue: false,
        duration: o.duration,
  ...
  if ($.uiBackCompat !== false) {
    ...
    $.widget("ui.tabs", $.ui.tabs, {
      ...
      enable: function (index) {
        ...
        if (
          (index && options.disabled === true) ||
          ($.isArray(options.disabled) &&
            $.inArray(index, options.disabled) !== -1)
        ) {
          trigger = true;
        }
    ...
    $.widget("ui.tabs", $.ui.tabs, {
      ...
      _tabId: function (tab) {
        ...
        a = a[0];
        return (
          $(a).closest("li").attr("aria-controls") ||
          (a.title &&
