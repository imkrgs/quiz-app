        ...
        <div id="horizontalTab">
          <ul class="resp-tabs-list">
            <li class="resp-tab-item">
              <span style="color: #5ff2be">Confirm Flight</span>
            </li>
          </ul>
          ...
          <div class="resp-tabs-container">
            <div class="tab-1 resp-tab-content roundtrip">
              <div class="card text-center">
                <div class="card-header"><%= details.get(id).getFlightNumber()%></div>
                <div class="card-body">
                  <h5 class="card-title"><%= details.get(id).getFlight()+" date : "+details.get(id).getDate()%></h5>
                  <p class="card-text">
                    Flight departure from  <%= details.get(id).getSource()%> to 
                    <%= details.get(id).getDestination()%> and timings are 
                    <%= details.get(id).getTime()%>
                  </p>
                  <a href="payment.html" style="background-color: #5ff2be" class="btn"
                    >Pay<%="   "+details.get(id).getPrice()%></a
                  >
                </div>
              </div>
            </div>
